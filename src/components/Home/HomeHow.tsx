const HomeHow = () => {
    return (
        <section id="how-it-work" className="pb-40 text-xl">
            ...
            <p>
                <span className="font-bold">Remixes:</span> The community will be provided with stems for each
            ...
            <p>
                <span className="font-bold">Remix Art:</span> PSD of original art is provided so that the community
            ...
            <p>
                <span className="font-bold">Social Content:</span> For every release the community will have the
            ...
            <p>
                <span className="font-bold">Song Royalties:</span> Every month there will be royalties that will
