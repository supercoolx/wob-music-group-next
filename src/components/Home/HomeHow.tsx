    ...
    return (
        <section id="how-it-work" className="pt-40 lg:text-xl">
            ...
            <div className="p-10 space-y-16 rounded-lg bg-stone-800">
                <div>
                    <div className="text-xl font-bold font-monument">Song Releases:</div>
                ...
                <div>
                    <div className="text-xl font-bold font-monument">Remixes:</div>
                ...
                <div>
                    <div className="text-xl font-bold font-monument">Remix Art:</div>
                ...
                <div>
                    <div className="text-xl font-bold font-monument">Social Content:</div>
                ...
                <div>
                    <div className="text-xl font-bold font-monument">Song Royalties:</div>
