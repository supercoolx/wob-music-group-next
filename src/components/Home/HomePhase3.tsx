        ...
        <section id="section-phase-3" className="pb-40">
            <div>
                ...
                <div className="flex justify-around pt-10">
                    <div className="px-5 py-2 border-2 text-[#eeff40] border-[#eeff40] rounded-full">SINGLE 1</div>
                    <div className="px-5 py-2 border-2 text-[#eeff40] border-[#eeff40] rounded-full">SINGLE 2</div>
                </div>
                <div className="pt-10 text-2xl text-center text-[#eeff40]">EP-5 SONGS</div>
            </div>
        </section>
    )
}
